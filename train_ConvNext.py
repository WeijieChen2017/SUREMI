...
train_dict["project_name"] = "ConvNext_Iman"
...
for model_key in model_state_keys:
    if model_key in pretrain_state_keys:
        new_model_state[model_key] = pretrain_state[model_key]
#     else:

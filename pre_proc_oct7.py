...
# pre_proc_dict["dir_orig"] = "./data_dir/dgx2/CT/"
# pre_proc_dict["name_orig"] = "MIMRTL-*__CT_reg_positive.nii.gz"
# pre_proc_dict["dir_syn"] = "./data_dir/dgx2/CT_norm/"
...
#         save_name = os.path.basename(file_path)[7:12]+".nii.gz"
...
pre_proc_dict["is_seg"] = False
pre_proc_dict["attr_seg"] = ["norm"]
pre_proc_dict["range_seg"] = [[0, 4000]]
pre_proc_dict["note"] = []
pre_proc_dict["time_stamp"] = time.strftime("%Y-%m-%d_%H:%M:%S", time.localtime())

...
model_list = [
    ...
    ["GCN_0001", "None", (0, ), "CT", [6], 0., 1, 1e-3],
    ["GCN_0010", "None", (0, ), "CT", [6], 0., 1, 1e-2],
    ["GCN_0100", "None", (0, ), "CT", [7], 0., 1, 1e-1],
    ["GCN_0500", "None", (0, ), "CT", [7], 0., 1, 5e-1],
...
unet_dict_G = {}
unet_dict_G["spatial_dims"] = 3
unet_dict_G["in_channels"] = 1
unet_dict_G["out_channels"] = 1
unet_dict_G["channels"] = (32, 64, 128, 256)
unet_dict_G["strides"] = (2, 2, 2)
unet_dict_G["num_res_units"] = 4
unet_dict_G["act"] = Act.PRELU
unet_dict_G["normunet"] = Norm.INSTANCE
unet_dict_G["dropout"] = 0.0
unet_dict_G["bias"] = True
train_dict["model_G"] = unet_dict_G

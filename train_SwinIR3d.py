...
train_dict["project_name"] = "SwinIR3d_Iman_v2"
...
train_dict["model_related"]["embed_dim"] = 24, 
train_dict["model_related"]["depths"] = [ 4, 4],
train_dict["model_related"]["num_heads"] = [ 8, 8],
...
# SwinIR3d
model = SwinIR3d(
    img_size=train_dict["model_related"]["img_size"][0], 
    patch_size=train_dict["model_related"]["patch_size"][0], 
    in_chans=train_dict["model_related"]["in_chans"][0],
    embed_dim=train_dict["model_related"]["embed_dim"][0], 
    depths=train_dict["model_related"]["depths"][0], 
    num_heads=train_dict["model_related"]["num_heads"][0],
    window_size=train_dict["model_related"]["window_size"][0], 
    mlp_ratio=train_dict["model_related"]["mlp_ratio"][0], 
    qkv_bias=train_dict["model_related"]["qkv_bias"][0], 
    qk_scale=train_dict["model_related"]["qk_scale"][0],
    drop_rate=train_dict["model_related"]["drop_rate"][0], 
    attn_drop_rate=train_dict["model_related"]["attn_drop_rate"][0], 
    drop_path_rate=train_dict["model_related"]["drop_path_rate"][0],
    norm_layer=train_dict["model_related"]["norm_layer"][0], 
    ape=train_dict["model_related"]["ape"][0], 
    patch_norm=train_dict["model_related"]["patch_norm"][0],
    use_checkpoint=train_dict["model_related"]["use_checkpoint"][0], 
    upscale=train_dict["model_related"]["upscale"][0], 
    img_range=train_dict["model_related"]["img_range"][0], 
    upsampler=train_dict["model_related"]["upsampler"][0], 
    resi_connection=train_dict["model_related"]["resi_connection"][0],
    )

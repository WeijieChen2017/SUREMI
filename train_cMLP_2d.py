...
train_dict["project_name"] = "CTGM_2d_v9_cMLP"
...
for idx_epoch_new in range(train_dict["epochs"]):
    ...
    for package in [package_train, package_val]: # , package_val
        ...
        x_data [batch_size, seq_len or num_vocab, n_features/cx*cx*2]
        """
        ...
        for cnt_file, file_path in enumerate(file_list):
            ...
            for ib in range(dz // batch_per_step):
                ...
                for iz in range(batch_per_step):
                    ...
                    batch_x[(iz-1)*num_vocab:iz*num_vocab, :] = x_c
                    batch_y[(iz-1)*num_vocab:iz*num_vocab, :] = x_y

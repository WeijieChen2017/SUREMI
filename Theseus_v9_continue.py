...
model_list = [
    ["syn_DLE_4444444", [7], [4,4,4,4,4,4,4], "296"],
    ["syn_DLE_4444444_e400", [7], [4,4,4,4,4,4,4], "182"],
...
train_dict["continue_training_epoch"] = model_list[current_model_idx][3]
...
train_dict["target_optim"] = train_dict["save_folder"]+"optim_{}.pth".format(train_dict["continue_training_epoch"])
...
dataset_list = np.load(train_dict["save_folder"]+"data_division.npy", allow_pickle=True).item()
train_list = dataset_list["train_list_X"]
val_list = dataset_list["val_list_X"]
test_list = dataset_list["test_list_X"]

...
__all__ = ["sliding_window_inference_vq3d"]


def sliding_window_inference_vq3d(
    inputs: torch.Tensor,
    ...
    **kwargs: Any,
    ...
    for slice_g in tqdm(range(0, total_slices, sw_batch_size)) if progress else range(0, total_slices, sw_batch_size):
        ...
        vq_loss, seg_prob_out, perplexity = predictor(window_data, *args, **kwargs)  # batched patch segmentation
    ...
    return vq_loss_list, final_output, perplexity_list
